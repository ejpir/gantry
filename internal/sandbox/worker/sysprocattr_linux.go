...
// SysProcAttr installs parent-death semantics: a supervisor crash
...
// ConfineProcAttr extends the worker's process attributes with user,
...
// tier honestly.
func ConfineProcAttr(attr *syscall.SysProcAttr) {
