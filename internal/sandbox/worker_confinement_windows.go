...
func prepareWindowsWorkerLaunch(restrictToken bool) (*windowsWorkerLaunch, error) {
...
func startWindowsWorkerProcess(exe string, argv, env []string, files []*os.File,
	handles []syscall.Handle, confinement string) (*os.Process, workerContainment, error) {
	...
	launch, err := prepareWindowsWorkerLaunch(restrictToken)
	if err != nil {
