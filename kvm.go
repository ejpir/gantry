...
// Linux/aarch64 using the raw KVM API — the same interface Docker's
// libsailor.so (rust-vmm style) uses, just without any frameworks.
package main
...
func (r kvmRunStruct) exitReason() uint64 { return uint64(le32(r.data[8:])) }
func (r kvmRunStruct) mmioPhys() uint64   { return le64(r.data[32:]) }
func (r kvmRunStruct) mmioData() []byte   { return r.data[40:48] }
func (r kvmRunStruct) mmioLen() uint32    { return le32(r.data[48:]) }
func (r kvmRunStruct) mmioIsWrite() bool  { return r.data[52] != 0 }
func (r kvmRunStruct) sysEventType() uint32 {
	return le32(r.data[32:])
}
...
func (r kvmRunStruct) ioPort() uint16    { return uint16(le32(r.data[34:])) }
func (r kvmRunStruct) ioCount() uint32   { return le32(r.data[36:]) }
func (r kvmRunStruct) ioData() []byte    { return r.data[r.ioDataOff():] }
func (r kvmRunStruct) ioDataOff() uint64 { return le64(r.data[40:]) }
